create or replace function function_producto_cantidad(idRestaurante bigint, idCategoria bigint, fechaIni date, fechaFin date)
returns table(
...
--select * from function_producto_cantidad(42, -1, '2019-11-01', '2019-11-15')